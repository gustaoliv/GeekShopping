    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "gusta.oliv4@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (38) 99127-7179",
                FirstName = "Gustavo",
                LastName = "Oliveira"
            };

            _user.CreateAsync(admin, "Gu@12345678").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Gu@12345678").GetAwaiter().GetResult();
